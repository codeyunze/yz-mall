package com.yz.mall.seata.tcc.order.config;
...
@Slf4j
@Component
public class FallbackAccountFeignServiceFactory implements FallbackFactory<TccStorageFeignService> {
    @Override
    public TccStorageFeignService create(Throwable throwable) {

        return new TccStorageFeignService() {
            @Override
