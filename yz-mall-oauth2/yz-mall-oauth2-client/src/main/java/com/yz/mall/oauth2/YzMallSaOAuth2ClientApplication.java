package com.yz.mall.oauth2;

import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;

/**
 * 启动：Sa-OAuth2 Client端
 *
 * @author yunze
 * @date 2024/8/6 星期二 23:36
 */
@SpringBootApplication
public class YzMallSaOAuth2ClientApplication {

    public static void main(String[] args) {
        SpringApplication.run(YzMallSaOAuth2ClientApplication.class, args);
