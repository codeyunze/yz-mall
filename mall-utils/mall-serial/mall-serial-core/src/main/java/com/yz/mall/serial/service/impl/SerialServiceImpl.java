...
public class SerialServiceImpl extends ServiceImpl<SerialMapper, SysUnqid> implements SerialService {
    ...
    @Override
    public String save(SerialAddDto dto) {
    ...
    @Override
    public boolean cachePersistence(SerialUpdateDto dto) {
        SysUnqid bo = new SysUnqid();
        BeanUtils.copyProperties(dto, bo);
    ...
    @Override
    public Page<SysUnqid> page(PageFilter<SerialQueryDto> filter) {
